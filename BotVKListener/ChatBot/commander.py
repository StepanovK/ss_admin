...
def suggest_text():
    return f'Напишите пожалуйста в предлагаемые новости @public{config.group_id} (на стене группы) (Поле ' \
           '"Предложить новость". Если такого поля нет, убедитесь, что вы подписаны на нашу группу.)' \
           '\nДля срочной публикации воспользуйтесь функцией "Позвать администратора" после того как предложили новость'
