...
- BotVKListener постоянно слушает новые события, парсит их и записывает в БД и кидает уведомление
...
Также можно запустить сервисы через docker-compose,  использовав файл `docker-compose.yaml` из корня проекта
